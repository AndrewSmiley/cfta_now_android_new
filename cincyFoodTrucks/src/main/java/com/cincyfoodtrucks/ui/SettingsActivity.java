...
public class SettingsActivity extends PreferenceActivity {
    //create vars to set the login username and password. Vanity stuff
	String provider;
    ...
    public void onCreate(Bundle savedInstanceState) {
             ...
             try {
                    userIntegrator.executeGetUserData();
            } catch (InterruptedException e) {
                    Toast.makeText(this, getResources().getText(R.string.strGenericError), Toast.LENGTH_LONG).show();
                    e.printStackTrace();
            }
    addPreferencesFromResource(com.cincyfoodtrucks.R.xml.preferences);
}
